...
<body>
    <div class="navgation">
        <div class="header">
            <div class="logo"><a href="index"><img id="mylogo" src="index images\mylogo for (2).PNG" alt="logo"></a>
            </div>
            <ul class="main">
                <li><a href="termspolicy">About</a></li>
                <li><a href="#"><i class="fas fa-user-lock"></i> Login</a>
                    <ul>
