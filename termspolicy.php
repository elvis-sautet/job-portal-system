    ...
    <div class="alltermss">
        <div class="thecookie">
            ...
            <p class="para">This Cookie policy helps to explain the occasions when and why cookies may be sent to
                ...
                record-keeping purposes. Cookies allow the Site to remember important information that will make
                your
                use of the site more convenient. A cookie will typically contain the name of the domain from which
                the
                cookie has come, the “lifetime” of the cookie, and a randomly generated unique number or other
                value.
                Certain cookies will be used on the Site regardless of whether you are logged in to your account or
                not.
                Session Cookies are temporary cookies that remain in the cookie file of your browser until you leave
                the
                Site.
            </p>
            ...
            <p class="para">These cookies, web beacons, and other storage technologies allow us to display
                ...
                may
                also
                share information about your behavior on the Site with third parties (including operators of
                third-party
                websites and/or social networking sites) in order to show you targeted advertisements and other
                content
                that has been customized for you. We also use these cookies, web beacons, and other storage
                technologies
                to facilitate the <?php echo $Company_name?> Targeted Ads Program. In connection with this Program
                and
                other
                advertising, we use these cookies, web beacons, and other storage technologies to determine which
                advertisements users have seen, how many times users have seen a particular advertisement, and on
                which
                sites a particular advertisement appeared. We may also use these cookies, web beacons, and other
                storage
                technologies on the Site to understand and inform an Employer about which users saw a particular Job
                Listing, Company Page, Hiring Event, or other advertisement in which the Employer is identified.</p>
            <h3>
            ...
            <p class="para"><?php echo $Company_name ?> and its affiliates use cookies to gather certain information
                ...
                make
                your user experience more consistent and convenient. For example, we may store the recent searches
                you
                have performed in a cookie so that we can allow you to easily repeat those searches when you return
                to
                our Site, or so that we can suggest profile information when you sign up for an account and fill out
                an
                <?php $Company_name  ?> Resume. In addition, we use cookies to maintain your logged in state when you
                visit our
                Site
                repeatedly. We may also use your IP address to determine your geographic location at city or postal
                code
                level in order to provide you with the most relevant search results.</p>
            <h3>
                <li class="numbering">

                    <? echo $Company_name ?> General Terms of Service</li>
                </ol>
            </h3>
            <h5>last Updated:
            ...
            <p class="para">You acknowledge and agree that Employers may request that <?php echo $Company_name?>
                ...
                <?php echo $Company_name?>
                into one document, and you agree that in doing so, <?php echo $Company_name?> assembles these
                application materials on your
                behalf. When you apply for a job on <?php echo $Company_name?> you agree to <?php echo $Company_name?>’s
                performance of automated processing in
                relation to your application, as such processing is an essential part of this Agreement. Additionally,
                you consent to your application and any responses sent to you by the Employer (including offer letters)
            ...
            <p class="para">When you apply to a job using
                ...
                applications will be delivered, received, accessed, read or acted upon.
                <?php echo $Company_name ?> also does not guarantee
                that any Employer will receive, be notified about, access, read or respond to any such resume or other
            ...
            <p class="para">By using
                ...
                that
                <?php echo $Company_name ?> does not guarantee receipt of your application by the Employer, or your
                receipt
                of messages
                from the Employer.</p>
            <p class="dire"><b> <?php echo $Company_name ?> does not guarantee the validity of a job offer and cautions
                    Job Seekers
                    to verify the validity
                    of a job offer before taking an adverse action regarding their current employment situations. Job
                    Seekers are solely responsible for verifying the accuracy of any Employer or job offer.</b></p>
